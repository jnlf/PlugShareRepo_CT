...
const crawler = new PlaywrightCrawler({
    ...
    maxConcurrency: 3, //how many workers running at the same time (maximum)
    maxRequestsPerMinute: 25, //number of requests to the website to make to the website in a minute
